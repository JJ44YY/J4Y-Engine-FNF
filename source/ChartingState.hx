...
class ChartingState extends MusicBeatState
{
	...
	function loadSong(daSong:String):Void
	{
		...
		FlxG.sound.playMusic('assets/music/songs/' + daSong + "_Inst" + TitleState.soundExt, 0.6);

		vocals = new FlxSound().loadEmbedded("assets/music/songs/" + daSong + "_Voices" + TitleState.soundExt);
